...
extern mower_logic::MowerLogicConfig getConfig(); //last_config;
extern void setConfig(mower_logic::MowerLogicConfig); //extern dynamic_reconfigure::Server<mower_logic::MowerLogicConfig> *reconfigServer;
